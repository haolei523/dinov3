...
from .datasets import ADE20K, CocoCaptions, CustomSegmentation, ImageNet, ImageNet22k, NYU
...
def _parse_dataset_str(dataset_str: str):
    ...
    elif name == "CustomSegmentation":
        class_ = CustomSegmentation
        if "split" in kwargs:
            kwargs["split"] = CustomSegmentation.Split[kwargs["split"]]
