...
def box_area(boxes):
    """boxes: [N, 4] in xyxy (absolute or normalized, consistent)"""
    return (boxes[:, 2] - boxes[:, 0]) * (boxes[:, 3] - boxes[:, 1])


def box_iou(boxes1, boxes2):
    """IoU between two sets of xyxy boxes. Returns (iou [N,M], union [N,M])."""
...
def generalized_box_iou(boxes1, boxes2):
    """Generalized IoU from https://giou.stanford.edu/. Inputs are xyxy boxes."""
